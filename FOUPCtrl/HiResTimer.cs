...
namespace FOUPCtrl
{
    public class HiResTimer
    {
        ...
        //---------------------- example of how the high-resolution counter -------------------------
        //static void Main()
        //{
        ...
        //    // Get time elapsed in millisecond.
        //    Int64 timeElapsedInTicks = counterAtEnd - counterAtStart;
        //    Int64 timeElapseInMilliseconds =
        //        (timeElapsedInTicks * 1000) / timer.Frequency;

        //    MessageBox.Show("Time Spent in operation (tenths of ms) "
        //                   + timeElapseInMilliseconds +
